      ...
      <div className="profile-creation">
        <div className="loginWrapper">
          <div className="loginLeft">
            <h3 className="profile-creation-title">Edit profile</h3>
          </div>
              ...
              <form className="profile-creation-box" onSubmit={handleClick}>
                ...
                <div className="names-container">
                  ...
                  <input
                    ...
                    type="date"
                    onChange={handleChangeValue}
                    value={moment(wallInformation.deathDate)
                      .utc()
                      .format('YYYY-MM-DD')}
                    name="deathDate"
                    ref={deathDate}
                ...
                <div className="radio-container">
                  ...
                  <div className="radio-input-container">
                    ...
                    <label
                      for="male"
                      className={`${
                        wallInformation.gender === 'male' && 'active'
                      } input-label`}
                    >
                      ז
                    </label>
                  ...
                  <div className="radio-input-container">
                    ...
                    <label
                      for="female"
                      className={`${
                        wallInformation.gender === 'female' && 'active'
                      } input-label`}
                    >
                      נ
                    </label>
